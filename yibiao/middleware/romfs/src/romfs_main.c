...
FILE    : $Id: romfs_main.c 3500 2014-08-06 09:44:55Z florian.zimmermann $
============================================================================ 
DESCRIPTION
...
int R_ROMFS_FClose(R_ROMFS_File_t *Fp) {
    if (Fp == 0) {
        return -1;
    }
    Fp->InUse = 0;
...
int R_ROMFS_DClose(R_ROMFS_Dir_t *Dp) {
...
int  R_ROMFS_Init(const R_ROMFS_Data_t *PData) {
    locRoot = PData;
    return 0;
}
